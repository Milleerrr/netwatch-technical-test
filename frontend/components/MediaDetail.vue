<template>
    <div class="mx-auto py-10">
        ...
        <div v-else class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="flex-grow">
                <h1 class="text-4xl font-bold mb-4 text-gray-800">{{ mediaItem?.title }}</h1>
                <p class="text-lg mb-6 text-gray-700">{{ mediaItem?.overview }}</p>
                <!-- Genres Section -->
                <div class="mb-6">
                    ...
                    <Collapsible v-model:open="isCastOpen" class="space-y-2">
                        <div class="flex items-center space-x-4">
                            <h1 class="text-lg font-semibold mb-2 text-gray-800">
                                Cast Members ({{ mediaItem?.cast.length }})
                            </h1>
